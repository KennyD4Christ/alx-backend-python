...
# Add these fixture definitions to the end of the fixtures.py file

# org_payload: Mocked JSON response for a GitHub organization
org_payload = {
    "login": "google",
    "id": 1342004,
    "node_id": "MDEyOk9yZ2FuaXphdGlvbjEzNDIwMDQ=",
...
# repos_payload: Mocked JSON response for repositories in a GitHub organization
repos_payload = [
    {
        "id": 1,
        "name": "repo1",
    ...
    },
    {
        ...
        "updated_at": "2020-01-01T00:00:00Z",
        "pushed_at": "2020-01-01T00:00:00Z",
        "git_url": "git://github.com/google/repo2.git",
        "ssh_url": "git@github.com:google/repo2.git",
        "clone_url": "https://github.com/google/repo2.git",
        "svn_url": "https://github.com/google/repo2",
        "homepage": None,
        "size": 200,
...
# expected_repos: List of repository names expected to be returned
expected_repos = ["repo1", "repo2"]

# apache2_repos: List of repository names that have the Apache 2.0 license
