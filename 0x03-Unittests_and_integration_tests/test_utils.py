...
class TestGetJson(unittest.TestCase):
    ...
    def test_get_json(self, test_url, test_payload):
        """
        Test get_json returns expected result and requests.get
        is called correctly.
        """
        with patch('utils.requests.get') as mock_get:
            ...
            # Test that requests.get was called exactly once with the test_url
...
class TestMemoize(unittest.TestCase):
    ...
    def test_memoize(self):
        """
        Test that a_method is only called once even when accessing
        a_property twice.
        """
